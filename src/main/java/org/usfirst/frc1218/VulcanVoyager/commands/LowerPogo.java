 ...
 */
public class LowerPogo extends Command {
    ...
    protected void initialize() {
        // Robot.claw.armIn();
        // Robot.climb.setMotorPower(Robot.climb.pogoTalon, -0.8);
        if (Robot.climb.pogoPot.get() >= 53.5){
            Robot.climb.setMotorPower(Robot.climb.pogoTalon, -0.8);
        }else{
    ...
    protected boolean isFinished() {
        // return false;
        return Robot.climb.pogoPot.get() <= 53.5;
