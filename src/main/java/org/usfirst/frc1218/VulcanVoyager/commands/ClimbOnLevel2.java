 ...
 */
public class ClimbOnLevel2 extends Command {
    ...
    protected void initialize() {
        Robot.claw.armIn();
        Robot.climb.setMotorPower(Robot.climb.scorpionTalon, -0.7);
        Robot.climb.setMotorPower(Robot.climb.pogoTalon, 0.48);
